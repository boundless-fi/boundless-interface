...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@boundless-fi/sdk'
...
function useSwapCallArguments(
  ...
  const recipient = recipientAddressOrName === null ? godwokenAddress : recipientAddress
...
export function useSwapCallback(
  ...
  return useMemo(() => {
    if (!trade || !library || !account || !chainId || godwokenAddress == null) {
  ...
  }, [trade, library, account, chainId, godwokenAddress, recipient, recipientAddressOrName, swapCalls, addTransaction])
}
