...
import { useAllTokens, useToken, useTokensByAddress } from '../../hooks/Tokens'
...
interface CurrencySearchProps {
  ...
  onChangeList: () => void
  tokens?: Token[]
  disableAddTokenByAddress?: boolean
}
...
export function CurrencySearch({
  ...
  onChangeList,
  tokens,
  disableAddTokenByAddress = false,
}: CurrencySearchProps) {
  ...
  const isAddressSearch = !disableAddTokenByAddress && isAddress(searchQuery)
  const searchToken = useToken(disableAddTokenByAddress ? undefined : searchQuery)
  ...
  const filteredTokens: Token[] = useMemo(() => {
    ...
    return filterTokens(Object.values(availableTokens), searchQuery)
  }, [isAddressSearch, searchToken, availableTokens, searchQuery])
